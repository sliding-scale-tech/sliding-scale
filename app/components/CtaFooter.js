            ...
            >
              ...
              <div className="cta-form w-form">
                ...
                >
                  ...
                  <div
                    id={`w-node-e6a86a55-d182-f743-64f9-0fad22d29c5a-${pageId}`}
                    className="div-block-55"
                  >
                    <label htmlFor="Share-project-details" className="brix---input-label">What are you building?</label>
                    <textarea
                      id="Share-project-details"
                      name="Share-project-details"
                      maxLength="5000"
                      data-name="Share project details*"
                      placeholder="Tell us about your idea..."
                      required
                      className={`form_input is-text-area w-node-de3d06bf-cfad-f8e1-b244-7c87f1428f4e-${pageId} w-input`}
                    ></textarea>
                  </div>
                  ...
                  <div
                    id={`w-node-de3d06bf-cfad-f8e1-b244-7c87f1428f4f-${pageId}`}
            ...
            <div className="container-2">
              <div className="footer-wrapper">
                <a
                  ...
                  className={`footer-brand w-inline-block${isIndex ? ' w--current' : ''}`}
                >
                  <img
                ...
                <div className="footer-content">
                  <div
                    id={`w-node-_184cf12b-41f7-09e1-bf4d-d891dfbd7ef1-${pageId}`}
                  ...
                  >
                    ...
                    <a
                      ...
                      className={`footer-link-2${isMvp ? ' w--current' : ''}`}
                    >
                      MVP Development
                    </a>
                    <a
                      ...
                      className={`footer-link-2${isAi ? ' w--current' : ''}`}
                    >
                      AI Automations
                    </a>
                  </div>
                  <div
                    id={`w-node-_184cf12b-41f7-09e1-bf4d-d891dfbd7ef8-${pageId}`}
                    className="footer-block"
                  >
                    ...
                    <a
                      ...
                      className={`footer-link-2${isPricing ? ' w--current' : ''}`}
                    >
                      Pricing
                    </a>
                  </div>
