  ...
  return (
    <html lang="en" suppressHydrationWarning>
      <head>
        ...
        <link
          rel="stylesheet"
          href="/css/sliding-scale-technologies.webflow.css"
        />
        <link
          rel="icon"
          type="image/png"
        ...
        <link
          ...
          type="image/png"
          sizes="48x48"
          href="/images/favicon-48.webp"
        />
        <link
          rel="apple-touch-icon"
          sizes="180x180"
          href="/images/webclip-180.webp"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="192x192"
          href="/images/webclip-192.webp"
        />
        <link
          rel="icon"
          type="image/png"
          sizes="512x512"
          href="/images/webclip.webp"
        />
      ...
      <body>
        ...
        <ScriptLoader />
        <script
          src="https://mukalma-web.vercel.app/loader.js"
          data-slug="slidingscale"
          data-cdn-url="https://mukalma-web.vercel.app"
